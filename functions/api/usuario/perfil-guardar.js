...
export async function onRequestPost(context) {
  ...
  try {
    ...
    const logo_url_recibido = limpiarTexto(body.logo_url);
    ...
    if (logo_url_recibido && !esUrlValidaOpcional(logo_url_recibido)) {
      return json({ ok: false, error: "La URL de la imagen no es valida" }, 400);
    }
