...
async function resolverPropietarioObjetivo(env, session, adminIdParam) {
...
export async function onRequestGet(context) {
  ...
  try {
    ...
    const propietarioDocumentalId = await resolverPropietarioObjetivo(env, session, url.searchParams.get("admin_id"));
    ...
    return json({
      ok: false,
      error: "No se pudo cargar la documentación activa del propietario documental.",
