...
export function construirEmailTextoReservaCondicionadaDocumentacion({
  ...
  const lineas = [
    "Tu solicitud ha quedado provisional porque la documentacion obligatoria asociada a la actividad esta pendiente de completar o actualizar.",
    "",
  ...
  lineas.push(
    "",
    "Mientras no regularices la documentacion, la solicitud quedara provisional.",
    "Dispones de 24 horas desde que queda provisional para completar o actualizar la documentacion. Si pasado ese plazo no queda regularizada, la solicitud pasara automaticamente a rechazada.",
...
export function construirEmailHtmlReservaCondicionadaDocumentacion({
  ...
  return `
    <p>Tu solicitud ha quedado provisional porque la documentacion obligatoria asociada a la actividad esta pendiente de completar o actualizar.</p>
    ...
    ` : ""}
    <p>Mientras no regularices la documentacion, la solicitud quedara provisional.</p>
    <p>Dispones de 24 horas desde que queda provisional para completar o actualizar la documentacion. Si pasado ese plazo no queda regularizada, la solicitud pasara automaticamente a rechazada.</p>
    ${enlace_perfil ? `
      <p>
